...
#define CTRLMMR_WKUP_DEVICE_FEATURE1		(WKUP_CTRL_MMR0_BASE + 0x64)
#define CTRLMMR_WKUP_DEVICE_FEATURE2		(WKUP_CTRL_MMR0_BASE + 0x68)
#define CTRLMMR_WKUP_DEVICE_FEATURE3		(WKUP_CTRL_MMR0_BASE + 0x6c)
#define CTRLMMR_WKUP_DEVICE_FEATURE6		(WKUP_CTRL_MMR0_BASE + 0x78)

#define DEVICE_FEATURE0_MPU_CORE_MASK		GENMASK(3, 0)
#define DEVICE_FEATURE0_MPU_CORE_SHIFT		0
#define DEVICE_FEATURE1_GPU			BIT(12)
#define DEVICE_FEATURE3_ICSSM0			BIT(18)
