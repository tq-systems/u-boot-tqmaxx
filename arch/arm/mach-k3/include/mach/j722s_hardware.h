...
#define JTAG_DEV_ID_MASK			GENMASK(31, 16)
#define JTAG_DEV_ID_SHIFT			16

#define JTAG_DEV_ID_AM6734			0x33F9
#define JTAG_DEV_ID_AM6754			0x33FA
#define JTAG_DEV_ID_AM67A74			0x33F8
#define JTAG_DEV_ID_AM67A94			0x33FB
#define JTAG_DEV_ID_TDA4AEN			0x33F1
#define JTAG_DEV_ID_TDA4VEN			0x33F0
#define JTAG_DEV_ID_XJ722S			0x3323
