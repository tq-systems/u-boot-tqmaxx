 ...
 * (C) Copyright 2019
 *
 * Configuration settings for the TQ Systems MBLS1028A-IND Carrier board
 * for TQMLS1028A module.
 *
 */
...
#define GPIO_EXPANDER1_I2C_ADDR		0x70
#define GPIO_EXPANDER2_I2C_ADDR		0x72
...
#define BOOT_ENV_BOARD                                                         \
	...
	"resetusb=i2c dev ${gpio_expander_i2c_bus}; "                          \
		"i2c mw ${gpio_expander_2_addr} 0x3 0x21; "                    \
		"i2c mw ${gpio_expander_2_addr} 0x1 0x7f; "                    \
		"sleep 0.1; "                                                  \
		"i2c mw ${gpio_expander_2_addr} 0x1 0x7d;\0 "                  \
	"resetphy=i2c dev ${gpio_expander_i2c_bus}; "                          \
		"i2c mw ${gpio_expander_1_addr} 0x3 0xd5; "                    \
		"i2c mw ${gpio_expander_1_addr} 0x1 0xd5; "                    \
		"sleep 0.1; "                                                  \
		"i2c mw ${gpio_expander_1_addr} 0x1 0xff;\0"                   \
