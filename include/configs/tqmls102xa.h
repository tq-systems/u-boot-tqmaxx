...
#if defined(CONFIG_HAS_FSL_XHCI_USB) && defined(CONFIG_USB_XHCI_FSL)
...
#if defined(CONFIG_DDR_ECC)
#define TQMLS102X_UBOOT_MMCSD_IMAGE_FILE	"u-boot-with-spl-pbl-ecc-mmcsd-2017.11.bin"
#define TQMLS102X_UBOOT_QSPI_IMAGE_FILE		"u-boot-pbl.bin.ecc.bswap"
#else
#define TQMLS102X_UBOOT_MMCSD_IMAGE_FILE	"u-boot-with-spl-pbl-mmcsd-2017.11.bin"
