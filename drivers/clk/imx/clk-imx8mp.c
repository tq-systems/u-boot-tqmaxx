...
static const struct imx_pll14xx_rate_table imx8mp_pll1443x_tbl[] = {
...
static struct imx_pll14xx_clk imx8mp_video_pll __initdata = {
		.type = PLL_1443X,
		.rate_table = imx8mp_pll1443x_tbl,
		.rate_count = ARRAY_SIZE(imx8mp_pll1443x_tbl),
};
...
static int imx8mp_clk_probe(struct udevice *dev)
{
	...
	clk_dm(IMX8MP_CLK_MEDIA_AXI, imx8m_clk_composite_critical("media_axi", imx8mp_media_axi_sels, base + 0x8a00));
	clk_dm(IMX8MP_CLK_MEDIA_APB, imx8m_clk_composite_critical("media_apb", imx8mp_media_apb_sels, base + 0x8a80));
	...
	clk_dm(IMX8MP_CLK_MEDIA_DISP2_PIX_ROOT, imx_clk_gate2("media_disp2_pix_root_clk", "media_disp2_pix", base + 0x45d0, 0));
