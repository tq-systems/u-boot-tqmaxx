...
static const struct mssr_mod_clk r8a774c0_mod_clks[] = {
	...
	DEF_MOD("drif31",		 508,	R8A774C0_CLK_S3D2),
	DEF_MOD("drif30",		 509,	R8A774C0_CLK_S3D2),
	DEF_MOD("drif21",		 510,	R8A774C0_CLK_S3D2),
	DEF_MOD("drif20",		 511,	R8A774C0_CLK_S3D2),
	DEF_MOD("drif11",		 512,	R8A774C0_CLK_S3D2),
	DEF_MOD("drif10",		 513,	R8A774C0_CLK_S3D2),
	DEF_MOD("drif01",		 514,	R8A774C0_CLK_S3D2),
	DEF_MOD("drif00",		 515,	R8A774C0_CLK_S3D2),
