...
/*
 * R8A774c0 processor support - PFC hardware block.
 *
...
/*
 * R8A774C0 has 7 banks with 32 GPIOs in each => 224 GPIOs.
...
static const struct sh_pfc_pin pinmux_pins[] = {
	 ...
	 *
	 * The pin positions are different between different R8A774C0
	 * packages, all that is needed for the pfc driver is a unique
	 * number for each pin. To this end use the pin layout from
	 * R8A774C0 to calculate a unique number for each pin.
	 */
...
static int r8a774c0_pin_to_pocctrl(struct sh_pfc *pfc, unsigned int pin, u32 *pocctrl)
{
	int bit = -EINVAL;
...
static unsigned int r8a774c0_pinmux_get_bias(struct sh_pfc *pfc,
					     unsigned int pin)
{
...
static void r8a774c0_pinmux_set_bias(struct sh_pfc *pfc, unsigned int pin,
				     unsigned int bias)
{
	const struct pinmux_bias_reg *reg;
	u32 enable, updown;
...
static const struct sh_pfc_soc_operations r8a774c0_pinmux_ops = {
	.pin_to_pocctrl = r8a774c0_pin_to_pocctrl,
	.get_bias = r8a774c0_pinmux_get_bias,
	.set_bias = r8a774c0_pinmux_set_bias,
};

const struct sh_pfc_soc_info r8a774c0_pinmux_info = {
	.name = "r8a774c0_pfc",
	.ops = &r8a774c0_pinmux_ops,
