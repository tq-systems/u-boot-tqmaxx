...
static const struct udevice_id imx_rproc_ids[] = {
	...
	{ .compatible = "fsl,imx94-cm70", .data = (ulong)&imx_rproc_cfg_imx94_m70 },
	{ .compatible = "fsl,imx94-cm71", .data = (ulong)&imx_rproc_cfg_imx94_m71 },
	{ .compatible = "fsl,imx94-cm33s", .data = (ulong)&imx_rproc_cfg_imx94_m33s },
	{}
};
