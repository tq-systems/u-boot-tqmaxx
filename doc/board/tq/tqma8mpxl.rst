...
TQ-Systems GmbH TQMa8MPxL SoM Family
===================================

The TQ-Systems TQMa8MPxL are System-on-Module based on the NXP i.MX8MP SoC family.

Module variants
---------------

Currently, following TQMa8MPxL variants with LPDDR4 RAM are supported:
...
* TQ-Systems TQMa8MPxL (REV.020x) on MBa8MPxL (REV.020x and newer) and
* TQ-Systems TQMa8MPxL (REV.020x) on MBa8MP-RAS314 (REV.010x)
...
the start full A52 U-Boot from fitImage container.
...
MBa8MPxL and MBa8MP-RAS314 DIP settings for boot sources
----------------------------------------------------------
...
+===================+==========+=====+=====+=====+=====+
| Serial Downloader | 0001     |  on | off | off | off |
+-------------------+----------+-----+-----+-----+-----+
| e-MMC (USDHC3)    | 0010     | off | on  | off | off |
+-------------------+----------+-----+-----+-----+-----+
| SD Card (USDHC2)  | 0011     |  on | on  | off | off |
+-------------------+----------+-----+-----+-----+-----+
| FlexSPI / 3B Read | 0110     | off | on  |  on | off |
+-------------------+----------+-----+-----+-----+-----+
