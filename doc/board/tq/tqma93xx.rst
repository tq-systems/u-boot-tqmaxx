...
+------------+------------+------+---------------------------------------+
| 0x2051A000 | 0x2051B000 |   8K | SPL_BSS_START_ADDR + SPL_BSS_MAX_SIZE |
+------------+------------+------+---------------------------------------+
| 0x2051C000 | 0x2051FFFF |  16K | SAVED_DRAM_TIMING_BASE                |
+------------+------------+------+---------------------------------------+
| 0x2049A000 | 0x204CFFFF | 216K | SPL (SPL_TEXT_BASE + SPL_MAX_SIZE)    |
+------------+------------+------+---------------------------------------+
| 0x204E0000 | 0x2051FFFF | 256K | TF-A (BL31_BASE ... BL31_LIMIT)       |
+------------+------------+------+---------------------------------------+
| 0x20519DD0 |            |      | SPL_STACK before DRAM                 |
+------------+------------+------+---------------------------------------+
