 ...
 */
static iomux_v3_cfg_t const mba6ulxl_fec1_pads[] = {
...
static iomux_v3_cfg_t const mba6ulxl_fec2_pads[] = {
...
static iomux_v3_cfg_t const mba6ulxl_fec_common_pads[] = {
	/* MDIO */
...
static void mba6ulxl_setup_iomuxc_enet(void)
{
	 ...
	 */
	imx_iomux_v3_setup_multiple_pads(mba6ulxl_fec_common_pads,
					 ARRAY_SIZE(mba6ulxl_fec_common_pads));
	imx_iomux_v3_setup_multiple_pads(mba6ulxl_fec1_pads,
...
static int mba6ulxl_setup_fec(int fec_id)
{
...
static iomux_v3_cfg_t const mba6ulxl_uart1_pads[] = {
...
static iomux_v3_cfg_t const mba6ulxl_uart6_pads[] = {
	NEW_PAD_CTRL(MX6_PAD_CSI_MCLK__UART6_DCE_TX,	UART_PAD_CTRL),
	NEW_PAD_CTRL(MX6_PAD_CSI_PIXCLK__UART6_DCE_RX,	UART_PAD_CTRL),
};
...
static struct i2c_pads_info mba6ulxl_i2c2_pads = {
/* I2C2: MBa6UL */
	.scl = {
...
static void mba6ulxl_setup_i2c(void)
{
	int ret;
...
int tqc_bb_board_init(void)
{
	...
	mba6ulxl_setup_fec(FEC0);
	mba6ulxl_setup_usb();

	return 0;
}

static iomux_v3_cfg_t const mba6ulxl_wdog_pads[] = {
...
int tqc_bb_board_late_init(void)
{
	...
	*/
	...
	imx_iomux_v3_setup_multiple_pads(mba6ulxl_wdog_pads,
					 ARRAY_SIZE(mba6ulxl_wdog_pads));
