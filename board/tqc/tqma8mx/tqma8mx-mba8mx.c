...
static struct tqc_gpio_init_data mba8mx_gid[] = {
	...
	GPIO_INIT_DATA_ENTRY(SD_SW_EN_B, "GPIO@23_8", GPIOD_IS_OUT |
	...
	GPIO_INIT_DATA_ENTRY(EN_HDMI_TERM, "GPIO@23_9", GPIOD_IS_OUT),
#endif
	GPIO_INIT_DATA_ENTRY(DSI_MUX_OE_B, "GPIO@23_10", GPIOD_IS_OUT |
			     GPIOD_ACTIVE_LOW),
	GPIO_INIT_DATA_ENTRY(EN_DP_BRIDGE_3V3, "GPIO@23_11", GPIOD_IS_OUT),

	GPIO_INIT_DATA_ENTRY(BOOT_CFG_OE_B, "GPIO@23_12", GPIOD_IS_OUT |
			     GPIOD_ACTIVE_LOW),
	GPIO_INIT_DATA_ENTRY(RST_USB_HUB_B, "GPIO@23_13", GPIOD_IS_OUT |
			     GPIOD_ACTIVE_LOW | GPIOD_IS_OUT_ACTIVE),
	GPIO_INIT_DATA_ENTRY(PCIE_RST_B, "GPIO@23_14", GPIOD_IS_OUT |
			     GPIOD_ACTIVE_LOW | GPIOD_IS_OUT_ACTIVE),
	...
	GPIO_INIT_DATA_ENTRY(AUDIO_CODEC_RESET_B, "GPIO@25_0", GPIOD_IS_OUT |
			     GPIOD_ACTIVE_LOW | GPIOD_IS_OUT_ACTIVE),
	GPIO_INIT_DATA_ENTRY(LCD_RESET_B, "GPIO@25_1", GPIOD_IS_OUT |
			     GPIOD_ACTIVE_LOW | GPIOD_IS_OUT_ACTIVE),
	...
	GPIO_INIT_DATA_ENTRY(CAMX_PWR_B, "GPIO@25_10", GPIOD_IS_OUT |
			     GPIOD_ACTIVE_LOW),
	GPIO_INIT_DATA_ENTRY(INT_MIKRO_MODULE, "GPIO@25_11", GPIOD_IS_IN),

	GPIO_INIT_DATA_ENTRY(MPCIE_DIS_B, "GPIO@25_12", GPIOD_IS_OUT |
			     GPIOD_ACTIVE_LOW | GPIOD_IS_OUT_ACTIVE),
	GPIO_INIT_DATA_ENTRY(MPCIE_RST_B, "GPIO@25_13", GPIOD_IS_OUT |
			     GPIOD_ACTIVE_LOW | GPIOD_IS_OUT_ACTIVE),
	GPIO_INIT_DATA_ENTRY(CAMX_RST_B, "GPIO@25_14", GPIOD_IS_OUT |
			     GPIOD_ACTIVE_LOW | GPIOD_IS_OUT_ACTIVE),
	GPIO_INIT_DATA_ENTRY(RESET_MIKRO_MODULE_B, "GPIO@25_15", GPIOD_IS_OUT |
			     GPIOD_ACTIVE_LOW | GPIOD_IS_OUT_ACTIVE),
