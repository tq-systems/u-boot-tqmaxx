...
static struct ctrl_dev *cdev = (struct ctrl_dev *)CTRL_DEVICE_BASE;
  ...
  #define DDR_CMD0_IOCTRL		K4B2G1646DBMK0_IOCTRL_VALUE

  #define DATA_PHY_RD_DQS_SLAVE_RATIO	K4B2G1646DBMK0_RD_DQS
  #define DATA_PHY_FIFO_WE_SLAVE_RATIO	K4B2G1646DBMK0_PHY_FIFO_WE /* RD DQS GATE */
  #define DATA_PHY_WR_DQS_SLAVE_RATIO	K4B2G1646DBMK0_WR_DQS
  #define DATA_PHY_WR_DATA_SLAVE_RATIO	K4B2G1646DBMK0_PHY_WR_DATA /* WRITE DATA */

  #define CMD_PHY_CTRL_SLAVE_RATIO	K4B2G1646DBMK0_RATIO
  #define CMD_PHY_INVERT_CLKOUT		K4B2G1646DBMK0_INVERT_CLKOUT

  #define ALLOPP_DDR3_SDRAM_CONFIG	K4B2G1646DBMK0_EMIF_SDCFG /* termination = 1 (RZQ/4) */
  #define ALLOPP_DDR3_REF_CTRL		K4B2G1646DBMK0_EMIF_SDREF /* 303 * 7.8us = 0x93B */
  #define ALLOPP_DDR3_ZQ_CONFIG		K4B2G1646DBMK0_ZQ_CFG

  #define ALLOPP_DDR3_SDRAM_TIMING1	K4B2G1646DBMK0_EMIF_TIM1
  #define ALLOPP_DDR3_SDRAM_TIMING2	K4B2G1646DBMK0_EMIF_TIM2
  #define ALLOPP_DDR3_SDRAM_TIMING3	K4B2G1646DBMK0_EMIF_TIM3

  #define EMIF_DDR_PHY_CTRL_1_REG	K4B2G1646DBMK0_EMIF_READ_LATENCY	/* RD_Latency = (CL + 2) - 1 */
#else
  #define DDR_CMD0_IOCTRL		K4B2G1646FBMK0_IOCTRL_VALUE

  #define DATA_PHY_RD_DQS_SLAVE_RATIO	K4B2G1646FBMK0_RD_DQS
  #define DATA_PHY_FIFO_WE_SLAVE_RATIO	K4B2G1646FBMK0_PHY_FIFO_WE /* RD DQS GATE */
  #define DATA_PHY_WR_DQS_SLAVE_RATIO	K4B2G1646FBMK0_WR_DQS
  #define DATA_PHY_WR_DATA_SLAVE_RATIO	K4B2G1646FBMK0_PHY_WR_DATA /* WRITE DATA */

  #define CMD_PHY_CTRL_SLAVE_RATIO	K4B2G1646FBMK0_RATIO
  #define CMD_PHY_INVERT_CLKOUT		K4B2G1646FBMK0_INVERT_CLKOUT

  #define ALLOPP_DDR3_SDRAM_CONFIG	K4B2G1646FBMK0_EMIF_SDCFG /* termination = 1 (RZQ/4) */
  #define ALLOPP_DDR3_REF_CTRL		K4B2G1646FBMK0_EMIF_SDREF /* 303 * 7.8us = 0x93B */
  #define ALLOPP_DDR3_ZQ_CONFIG		K4B2G1646FBMK0_ZQ_CFG

  #define ALLOPP_DDR3_SDRAM_TIMING1	K4B2G1646FBMK0_EMIF_TIM1
  #define ALLOPP_DDR3_SDRAM_TIMING2	K4B2G1646FBMK0_EMIF_TIM2
  #define ALLOPP_DDR3_SDRAM_TIMING3	K4B2G1646FBMK0_EMIF_TIM3

  #define EMIF_DDR_PHY_CTRL_1_REG	K4B2G1646FBMK0_EMIF_READ_LATENCY	/* RD_Latency = (CL + 2) - 1 */
#endif
