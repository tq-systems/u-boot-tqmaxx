...
const char *tq_get_boardname(void)
{
	...
	/* IMX9322 / IMX9321 / IMX9312 / IMX9311 not assembled, 9x9mm package */
	case MXC_CPU_IMX9302:
		return "TQMa9302"; /* iMX93 Dual core / reduced frequency without NPU */
	case MXC_CPU_IMX9301:
		return "TQMa9301"; /* iMX93 Single core / reduced frequency without NPU */
	}
